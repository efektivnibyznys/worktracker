...
export function EntrySelector({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-gray-50 rounded-lg sticky top-0 z-10 gap-3 sm:gap-0">
      ...
      {someSelected && (
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-blue-50 rounded-lg border border-blue-200 sticky bottom-0 gap-3 sm:gap-0">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            <span className="font-medium">Vybráno:</span>
            <Badge>{stats.count} záznamů</Badge>
            <span className="text-gray-600 whitespace-nowrap">{formatTime(stats.totalMinutes)}</span>
          </div>
          <div className="text-xl font-bold self-end sm:self-auto">
